...
class Email
  ...
  def format_emails (email_tab)

  email_tab do |mail| # on va chercher les infos de chaque ligne dans le csv (sans la première ligne)
...
def format_emails_djeuns (email_tab)
...
Charles, co-fondateur de The Hacking Project pourra répondre à toutes vos questions : 06.95.46.60.80."
  ...
  def format_emails_town (email_tab)
